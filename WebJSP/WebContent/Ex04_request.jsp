<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    //2. 클라이언 서버에 전송을 요청(클라이언트 수 많은 정보가 전달>> 정보를 받는 객체 request)
    //입력값, IP, 브라우져 정보, 전송방식
    //request 내장 객체는 클라이언트에서 서버로 요청할떄 생성되는
    //HttpServletRequest 타입을 ㄱ자는 객체가 자동 생성되고 그 주소를 request 참조
...
<body>
	...
	서버(요청한 인코딩):<%=request.getCharacterEncoding() %>
