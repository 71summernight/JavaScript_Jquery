...
session 객체
[내부에 session 변수생성]
scope: a.jsp(session.setAtt.."member" 변수생성)
	   b.jsp(sessionn.getAtt..."member" 사용가능)
...
scope: (guswo WebContent 폴더안에 있는 모든 페이지에서 사용 가능)>java >>static
