...
파일 업로드 구현(실 저장 경로)
	...
	실경로(소스): /Users/71summernight/Weblab/WebJSP/WebContent/Ex09_WebAPP_RealPath.jsp 
	실제 소스: 배포되어서서비스 되고 있는 소스>>톰켓이 가지는 특정 경로
	
	아파치 톰켓의 서비스 경로(배포)
	/Users/71summernight/Weblab/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps
	resourcepath>>/download/note.txt
	
	소스경로:/Users/71summernight/Weblab/WebJSP/WebContent/resourcepath/download/note.txt

	배포경로:/Users/71summernight/Weblab/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps
